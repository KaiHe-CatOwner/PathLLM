...
#SBATCH -o ./logs/slurm_wsi_s1_abmil.%N.%j.out # STDOUT
#SBATCH -e ./logs/slurm_wsi_s1_abmil.%N.%j.err # STDERR
...
accelerate launch --config_file=./accelerate_configs/deepspeed_zero2.yaml run_wsi.py --max_steps 20_000 --warmup_steps 200\
        ...
        --output_dir ./output/WSI_ConchLlama3.1_sample_Stage2 --agg_strategy gmm --embed_dim 1025\
        --llm_name meta-llama/Meta-Llama-3.1-8B-Instruct \
        --dataset_name_list CNX-PathLLM/TCGA-WSI-OpenQA,CNX-PathLLM/GTEx-WSI-OpenQA,CNX-PathLLM/TCGA-WSI-CloseQA-Balanced,CNX-PathLLM/GTEx-WSI-CloseQA-Balanced\
        --data_cache_dir /bask/projects/p/phwq4930-renal-canc/Zeyu/PathVLM/.cache \
        --fea_root /bask/homes/a/asiw9691/PathVLM/WSI_Dataset/GMM_PT \
