...
accelerate launch --config_file=./accelerate_configs/deepspeed_zero2.yaml run.py --max_steps 20_000\
        --gpu 3 --train_batch_size 6 --eval_batch_size 2 --max_seq_length 256 --resume_from_checkpoint False --output_dir ./Conch_Llama3_PatchInstruct_IT\
        ...
        --dataset_local_paths /home/z/zeyugao/dataset/YoutubePathQA/pretrain_data_all --data_cache_dir ~/.cache\
