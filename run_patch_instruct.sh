...
accelerate launch --config_file=./accelerate_configs/deepspeed_zero2.yaml run_patch_instruct.py --max_steps 20_000\
        ...
        --output_dir /bask/homes/a/asiw9691/PathVLM/source/PathLLM/output/Conch_Llama3.1_Stage12_lora8\
        ...
        --ckpt_path /bask/homes/a/asiw9691/PathVLM/source/PathLLM/output/Conch_Llama3.1_Stage1/checkpoint-20000/ckpt20000.bin 
