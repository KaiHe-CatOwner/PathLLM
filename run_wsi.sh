...
accelerate launch --config_file=./accelerate_configs/deepspeed_zero2.yaml run_wsi.py --max_steps 20_000 --warmup_steps 200\
        ...
        --output_dir ./output/WSI_ConchLlama3.1_ABMIL_Step1 --agg_strategy longnet\
        --llm_name meta-llama/Meta-Llama-3.1-8B-Instruct --dataset_name_list CNX-PathLLM/TCGA-WSI-Description\
        --data_cache_dir /data_nas2/pxb/CNX-PathLLM/.cache \
        --fea_root /data/CNX-PathLLM/GTEx-TCGA-Embeddings \
        --n_heads 32,16,8 --llm_requires_grad False \
        --data_local_dir /data/CNX-PathLLM/TCGA-WSI-Description
...
# --llm_name meta-llama/Meta-Llama-3-8B-Instruct, meta-llama/Meta-Llama-3.1-8B-Instruct, Qwen/Qwen1.5-1.8B
