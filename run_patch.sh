...
accelerate launch --config_file=./accelerate_configs/deepspeed_zero2.yaml run_patch.py --max_steps 20_000\
        --gpu 3 --train_batch_size 6 --eval_batch_size 2 --max_seq_length 256 --resume_from_checkpoint False --output_dir /home/shared/su123/LLM_ckpt/Conch_Llama3_Patch_ITDes\
        --llm_name meta-llama/Meta-Llama-3-8B-Instruct --clip_name conch --data_cache_dir ~/.cache\
        --dataset_local_paths /home/z/zeyugao/YoutubePathQA/pretrain_data_all\
