...
accelerate launch --config_file=./accelerate_configs/deepspeed_zero2.yaml run_qformer.py \
        --gpu 2 --train_batch_size 16   --eval_batch_size 2 --max_seq_length 256 --resume_from_checkpoint False --output_dir ./Conch_Llama3ins_InstructFull\
        --llm_name meta-llama/Meta-Llama-3-8B-Instruct --clip_name conch --dataset_name_list CNX-PathLLM/Pathinstruct,CNX-PathLLM/MultiConversation,CNX-PathLLM/TextbookQAPair\
