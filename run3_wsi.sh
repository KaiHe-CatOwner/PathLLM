...
#SBATCH -o ./logs/slurm_wsi_s1_sample.%N.%j.out # STDOUT
#SBATCH -e ./logs/slurm_wsi_s1_sample.%N.%j.err # STDERR
...
accelerate launch --config_file=./accelerate_configs/deepspeed_zero2.yaml run_wsi.py --max_steps 20_000 --warmup_steps 200\
        ...
        --output_dir ./output/WSI_ConchLlama3.1_SAMPLE_Step1 --agg_strategy sample --embed_dim 512\
