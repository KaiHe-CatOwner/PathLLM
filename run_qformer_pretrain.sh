...
accelerate launch --config_file=./accelerate_configs/deepspeed_zero2.yaml run_qformer_pretrain.py --learning_rate 1e-4 --max_steps 200_000 --warmup_ratio 0.01\
        --gpu 3 --train_batch_size 64 --eval_batch_size 2 --max_seq_length 256 --resume_from_checkpoint False --output_dir ./output/Conch_Bert_PatchPre\
        ...
        --dataset_local_paths /home/z/zeyugao/dataset/YoutubePathQA/pretrain_data_all\
