...
accelerate launch --config_file=/bask/homes/a/asiw9691/PathVLM/source/PathLLM/accelerate_configs/deepspeed_zero2.yaml run.py  --gpu 2 --train_batch_size 6   --eval_batch_size 4 --max_seq_length 256 --resume_from_checkpoint True --output_dir ./PathClip_Mistral-7B_4dataset
